...
<body>
  ...
  <section class="content">
    ...
    <p align="center">
      <img src="http://192.168.4.13/capture" id="photo" width=300em>
      <br>
    ...
    <script>
      ...
      function refresh_img() {
        if (isStreaming && (!isRecording)) {
          document.getElementById("photo").src = "http://192.168.4.13/capture"
                                                 + '?_=' + (new Date()).getTime();
        }
      }
    ...
    <p align="center">
      ...
      <script>
        ...
        document.getElementById('start_record').onclick = function() {
          xhttp.open("GET", "http://192.168.4.13/record?record_time="
